Please run example.m. You will get the same results presented in the paper "Scheduling Real-Time Parallel Applications in Cloud to Minimize Energy Consumption".
